...
public class LVCircular extends View {
    ...
    private static LVCircular sLVCircular;

    public static LVCircular getInstance() {
        if (sLVCircular == null) {
            synchronized (LVCircular.class) {
                if (sLVCircular == null)
                    sLVCircular = new LVCircular(DemoApplicatoin.context);
            }
        }
        return sLVCircular;
    }
