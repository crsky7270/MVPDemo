...
import com.booway.mvpdemo.utils.VideoFeedView;
    ...
    private void initCallbacks() {
        setBandwidthCallback = new SetCallback() {
            ...
            public void onSuccess() {
                ToastUtils.showToast("Set key value successfully");
            ...
            public void onFailure(@NonNull DJIError error) {
                ToastUtils.showToast("Failed to set: " + error.getDescription());
            }
        };
        ...
        sourceListener = new VideoFeeder.PhysicalSourceListener() {
            ...
            public void onChange(VideoFeeder.VideoFeed videoFeed, VideoFeeder.PhysicalSource newPhysicalSource) {
                ...
                if (videoFeed == VideoFeeder.getInstance().getSecondaryVideoFeed()) {
                    ToastUtils.showToast("Secondary Source: " + newPhysicalSource.toString());
                }
            }
        };
        ...
        if (product != null) {
            ...
            if (isOpen) {
                ...
                if (isMultiStreamPlatform()) {
                    ...
                    ToastUtils.showToast(newTextFpv);
                }
    ...
    private boolean isM210TwoCameraConnected() {
        ...
        if (model != null) {
            ...
            if (product != null && (product instanceof Aircraft)) {
                ...
                ToastUtils.showToast(cameraListStr);
...
//        TmpApplication.getEventBus().post(new MainActivity.RequestStartFullScreenEvent());
    }
